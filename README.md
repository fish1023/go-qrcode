...
Package qrcode implements a QR Code encoder. [![Build Status](https://travis-ci.org/fish1023/go-qrcode.svg?branch=master)](https://travis-ci.org/fish1023/go-qrcode)
...
## Install
    ...
    go get -u github.com/fish1023/go-qrcode/...

A command-line tool `qrcode` will be built into `$GOPATH/bin/`.

## Usage

    import qrcode "github.com/fish1023/go-qrcode"
...
[![godoc](https://godoc.org/github.com/fish1023/go-qrcode?status.png)](https://godoc.org/github.com/fish1023/go-qrcode)
...
https://github.com/fish1023/go-qrcode
...
Usage:
  ...
  2. Save to file if "display" not available:
       ...
       qrcode "homepage: https://github.com/fish1023/go-qrcode" > out.png
